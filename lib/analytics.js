...
class Analytics extends EventEmitter {
    ...
    startSystemMonitoring() {
        ...
        if (this.systemMonitoringInterval.unref) {
    ...
    // Cleanup function to stop all timers and clear resources
    cleanup() {
        ...
        // Clean up any other resources (file handles, custom timers, etc.)
